<template>
  <div
    :class="[
      ...
      'border-neutral-600',
      'rounded-lg',
      { 'bg-neutral-600 bg-opacity-20': showContents }
    ]"
  >
    <button
      class="flex items-center justify-between w-full p-3 pr-4 pl-5 font-bold hover:border-neutral-500"
      type="button"
    ...
    <transition name="show-down">
      <div v-if="showContents" class="border-t border-neutral-600">
        <dl v-if="props.isInfo" class="p-4 grid grid-cols-4 text-sm md:text-base">
