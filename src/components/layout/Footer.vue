<template>
  ...
  >
    ...
    >
      <!-- prettier-ignore -->
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="2 2 20 20" width="20px" height="20px" class="w-5 h-auto fill-current">
    ...
    <p class="col-span-2 mt-12 text-xs text-neutral-400">
