    ...
    <div class="px-2 md:px-3">
      ...
      <p
        ...
        :class="[
          ...
          props.isSmall
            ...
            : 'h-8 px-1 text-sm md:h-10 md:px-2 md:text-base'
        ]"
      >
      ...
      <p
        ...
        :class="[
          ...
          props.isSmall
            ? 'text-xs md:text-md'
            : 'h-8 px-1 text-sm leading-8 md:h-10 md:px-2 md:text-[20px] md:leading-10'
        ]"
      >
        {{ props.cardName }}
      </p>
      ...
      <p
        ...
        :class="[
          ...
          'text-neutral/60',
          'font-medium',
          props.isSmall ? 'pb-2 text-[10px] md:text-md' : 'px-1 text-xs md:px-2 md:text-sm'
        ]"
      >
        Bora Testnet
      </p>
