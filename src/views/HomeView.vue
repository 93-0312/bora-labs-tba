<template>
  <main class="px-5 pt-8 pb-20 md:px-7">
    <section class="overflow-hidden relative">
      ...
      <p class="py-4 text-lg">ERC-6551은 NFT를 지갑처럼 사용할 수 있는 기능입니다.</p>
      <ul class="text-sm text-neutral-400">
        <li>ERC-6551이 적용된 NFT는 지갑처럼 여러개의 토큰과 NFT를 넣을 수 있습니다.</li>
        <li>ERC-6551 NFT를 게임 계정으로 이용하면, 지갑 이동이나 새로운 계정을 생성할 때 유용합니다.</li>
      </ul>

      <!-- like -->
      <label className="swap absolute right-1 top-1"> 
        <input type="checkbox" />
